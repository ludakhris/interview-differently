    ...
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12 animate-fade-in">
        <div className="mb-8">
          ...
          <h1 className="font-display font-extrabold text-[24px] text-[#f5f3ee] tracking-tight">Platform Settings</h1>
        </div>
        ...
        <div className="bg-[#111111] rounded-xl border border-white/10 px-6">
          <p className="text-[11px] font-bold uppercase tracking-widest text-slate-mid pt-5 pb-3">Evaluation</p>
          {!loaded ? (
        ...
        <div className="bg-[#111111] rounded-xl border border-white/10 px-6 mt-4">
          <p className="text-[11px] font-bold uppercase tracking-widest text-slate-mid pt-5 pb-3">Organisation</p>
          <button
